#### GenEgenskaperKorallbunntyper (abstrakt)
...
Observasjoner av ulike korallbunntyper (Levende Lophelia, Korallgrus og Død Lophelia) er loggført i felt under videoundersøkelse av havbunnen.<br /><br />Observations of coral substrates (Live Lophelia, Coral rubble, and Dead Lophelia) are registered in the field during video investigations of the sea-bed.
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>toktnummer ved Havforskningsinstituttet.<br />Cruise number at IMR.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>referansestasjon, unik innen MAREANO.<br />Reference number during MAREANO prosject (superstation).</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>prøvenummer for redskapet, unikt innen toktNummer.<br />Sample number for the equipment, unique on cruisenumber.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>korallrevNummer</strong></td>
    </tr>
    <tr>
      <th scope="row">Definisjon:</th>
      <td>korallrev nummer.<br /><br />Coral reef code.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>0..1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    <tr>
      <th scope="row">Navn:</th>
      <td><strong>korallrevBunntype</strong></td>
    </tr>
    <tr>
      <th scope="row">Definisjon:</th>
      <td>observert bunntype mht. korallrev.<br />Observered bottomtype regarding to coral reefs.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
    ...
    <tr>
      <th scope="row">Type:</th>
      <td>KorallrevBunntype</td>
    </tr>
    <tr>
      <th scope="row">Tillatte verdier:</th>
      <td>- Kodeliste: <a href="http://skjema.geonorge.no/legg_inn_riktig_url">http://skjema.geonorge.no/legg_inn_riktig_url</a><br />- korallgrus – Korallgrus: små skjelett-fragmenter (&lt; 20 cm) av døde Lophelia koraller.
Coral rubble: small skeleton fragments (&lt; 20 cm) of dead Lophelia corals<br />- dødLophelia – død Lophelia: større (&gt;20 cm) fragmenter av døde korallskjeletter.
Dead Lophelia: larger (&gt;20 cm) fragments of dead coral skeleton.<br />- levendeLophelia – levende Lophelia: kolonier av levende Lophelia, med ulik størrelse.
Live Lophelia: colonies of living Lophelia, of different sizes.<br />- ingenKorallerObservert – ingen koraller observert: Ingen korallrev observert på videotransektet (midtposisjon).
No coral observations: No observations of coral reefs at the videotransekt (shown with middle posiston).</td>
    </tr>
  </tbody>
</table>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>observasjonsdato.<br />Date of observation.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>bunndyp der observasjonen ble gjort.<br />Bottomdepth where the observation was made.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>breddegrad som observasjonen ble gjort på.<br />Latitude where the observation was made.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
<table class="feature-attribute-table">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">Definisjon:</th>
      <td>lengdegrad som observasjonen ble gjort på.<br />Longitude where the observation was made.</td>
    </tr>
    <tr>
      <th scope="row">Multiplisitet:</th>
      <td>1</td>
...
#### «Enumeration» KorallrevBunntype

**Definisjon:** kodeliste for observert bunntype mht. korallrev.
Code list for observered bottomtype regarding to coral reefs.
...
<table class="code-list-table">
  ...
  <tbody>
    <tr>
      <td>korallgrus</td>
      <td>Korallgrus: små skjelett-fragmenter (&lt; 20 cm) av døde Lophelia koraller.
Coral rubble: small skeleton fragments (&lt; 20 cm) of dead Lophelia corals</td>
      <td></td>
    </tr>
    <tr>
      <td>dødLophelia</td>
      <td>død Lophelia: større (&gt;20 cm) fragmenter av døde korallskjeletter.
Dead Lophelia: larger (&gt;20 cm) fragments of dead coral skeleton.</td>
      <td></td>
    </tr>
    <tr>
      <td>levendeLophelia</td>
      <td>levende Lophelia: kolonier av levende Lophelia, med ulik størrelse.
Live Lophelia: colonies of living Lophelia, of different sizes.</td>
      <td></td>
    </tr>
    <tr>
      <td>ingenKorallerObservert</td>
      <td>ingen koraller observert: Ingen korallrev observert på videotransektet (midtposisjon).
No coral observations: No observations of coral reefs at the videotransekt (shown with middle posiston).</td>
      <td></td>
    </tr>
  </tbody>
